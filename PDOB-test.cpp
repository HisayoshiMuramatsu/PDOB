...
// Inverse model of the motor system used by the PDOB
...
int main(){
	...
	*/
	...
	std::cout << "=====================================" << std::endl;
	std::cout << "           PDOB SIMULATION          " << std::endl;
	std::cout << "=====================================" << std::endl;
	...
	*/
	do{
		...
		*/
		// ---------- PDOB ----------
		// Error computation: Difference between reference force and actual force due to periodic disturbance
		...
		for(int i(0); i<100; i++){
			...
			*/
			// Fundamental frequency for the periodic disturbance
			Omega = 100;
			Dp = 0.0;
			for(int i(1); i<11; i++){
